...
Сейчас на результат влияют только пресеты ударных: `drums` и `drums_1line` идут
прямо в Audiveris (homr ударных не знает), остальные принимаются, но распознаёт
homr и они ни на что не действуют. Подробности — в [PRESETS.md](PRESETS.md).
